...
class _VerifyResetCodeScreenState extends ConsumerState<VerifyResetCodeScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
        ...
        if (!didPop) {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: const Text('Are you sure you want to cancel the password reset process?'),
              actions: [
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('Verify Reset Code'), automaticallyImplyLeading: false),
        body: SafeArea(
