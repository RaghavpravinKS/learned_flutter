...
class AllLearningMaterialsScreen extends ConsumerWidget {
  const AllLearningMaterialsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final materialsAsync = ref.watch(allStudentMaterialsProvider);
        ...
        error: (error, stack) => Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              ElevatedButton(onPressed: () => ref.refresh(allStudentMaterialsProvider), child: const Text('Retry')),
            ],
          ),
        ),
        data: (materials) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Materials will appear here once your teachers upload them',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (material.classroomName != null) ...[
                      Text(
                        '${material.classroomName}${material.teacherName != null ? " • ${material.teacherName}" : ""}',
